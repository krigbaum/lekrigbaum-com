...
<body>
            ...
            <nav>
                <ul>
                    <li><a href="../index.html">Home</a>
                        <li><a href="wartree.html">Wartree</a></li>
    ...
    <main>
        <br>
        <br>
        <div id="page-title">Request an Account</div>
        <div class="login-page">
            <div class="form">
                <form class="login-form">
                    ...
                    <p class="message">It will take 1 to 3 days for an account request to be approved or 
                        denied.  You will receive an e-mail response with further instructions.</p>
                 </form>
            </div>
        </div>
